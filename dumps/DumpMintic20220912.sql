...
) ENGINE=InnoDB AUTO_INCREMENT=54991 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
DROP TABLE IF EXISTS `stresults`;
...
CREATE TABLE `token` (
  `token_access_point_srv1` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
  `token_access_point_srv2` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
  `token_router_switch_srv1` varchar(200) COLLATE latin1_spanish_ci NOT NULL,
  `fecha` timestamp NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
DELIMITER ;;
