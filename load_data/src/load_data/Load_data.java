...
public class Load_data {
    ...
    public String[] generar_tokens(Properties properties) {
        String[] tokens = new String[3];
        tokens[0] = get_token_from_server(properties.getProperty("URL_RD_SW_TOKEN"),properties.getProperty("USR_RD_SW_CLIENT_ID"),properties.getProperty("USR_RD_SW_CLIENT_SECRET"));
        tokens[1] = get_token_from_server(properties.getProperty("URL_AP1_TOKEN"),properties.getProperty("USR_AP1_CLIENT_ID"),properties.getProperty("USR_AP1_CLIENT_SECRET"));
        tokens[2] = get_token_from_server(properties.getProperty("URL_AP2_TOKEN"),properties.getProperty("USR_AP2_CLIENT_ID"),properties.getProperty("USR_AP2_CLIENT_SECRET"));
        return tokens;
    }
