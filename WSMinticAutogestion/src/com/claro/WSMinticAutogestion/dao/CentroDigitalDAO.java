	...
	public CentroDigitalVO findById(String id_beneficiario){
		...
		try {
			if(this.connection.isValid(10)) {
				...
				if (resultSet.next()) {
					centroDigitalVO = new CentroDigitalVO(resultSet.getString(1),resultSet.getString(2),resultSet.getString(3),resultSet.getString(4),resultSet.getString(5),resultSet.getString(6),resultSet.getString(7),resultSet.getString(8),resultSet.getInt(9));
